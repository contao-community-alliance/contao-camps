...
- Wie gehe ich besten mit meiner code versionierung um, damit ich später auch noch etwas wiederfinde ? siehe präsentationsfolien [github-repo](https://github.com/friebe/building-blocks-presentation) oder [hier](./folien-versionsverwaltung-friebe.pdf) 
...
- Wen das Thema (TypeScript-first schema validation with static type inference) trotzdem interessiert, kann sich unter folgendem Link informationen einholen [zod.js](https://zod.dev/)
