...
- Dienst contao.contact vorgestellt und Intention am Beispiel [lindesbs.contao.contact](https://lindesbs.contao.contact) erklaert.
- Bundle ist frei verfuegbar
- Einbindung der VCF und QRCode Generierung ueber weiteres Paket vorgesehen (https://github.com/lindesbs/MemberQRCode)
  Dieses wird noch erweitert durch ContentElemenete/Module fuer die Einzel und Mehrfachgenerierung von VCF/QRCode
